  ...
  return (
    <Layout title="home">
      ...
      <p style={{ color: "black" }}>
        ...
        aspernatur iste non assumenda placeat, nostrum similique quisquam ipsum
        pariatur eaque. Reprehenderit impedit veritatis asperiores voluptatum
        itaque natus magnam soluta.
      </p>
      {/* </Section> */}
    </Layout>
  );
